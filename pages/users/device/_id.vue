...
<template>
  <div>
    ...
    <div v-else>
      <pageheader
        :title="'Device detail :' + $nuxt.$route.params.id"
        :urlto="$nuxt.context.from ? $nuxt.context.from.fullPath : '/users'"
        urltxt="Go back"
      ></pageheader>
      <div class="row">
        <div class="col-12">
          <h5 class="mt-3">Users who have used this device to login</h5>
          <v-server-table
            :url="
              serverurl + 'admin/users/device-data/' + $nuxt.$route.params.id
            "
          ...
          >
            ...
            <div slot="actions" slot-scope="{ row }">
              ...
              <button class="btn" @click="showLocationDetails(row)" title="IP Address detail">
