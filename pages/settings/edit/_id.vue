        ...
        <div class="card">
          <div class="card-content">
            <form class="form form-vertical">
              <div class="form-body">
                <div class="row">
                  <custom-form :validator="$v.form.key" attribute="Key">
                    <div class="col-12">
                      <div class="form-group has-icon-left">
                        <label for="first-name-icon">Name</label>
                        <div class="position-relative">
                          <input
                            :class="{ 'is-invalid ': $v.form.key.$error }"
                            v-model="form.key"
                            @input="$v.form.key.$touch()"
                            name="key"
                            type="text"
                            class="form-control"
                  ...
                  <custom-form :validator="$v.form.value" attribute="value">
                    <div class="col-12">
                      <div class="form-group has-icon-left">
                        <label for="first-name-icon">Name</label>
                        <div class="position-relative">
                  ...
                  <div class="col-12">
                    <fieldset class="form-group">
                      <label for="basicSelect"
                        >Icon (font awesome 4) optional</label
                      >
                      <select
                        class="form-select"
                        id="basicSelect"
                        v-model="form.fa4_icon"
                        name="fa4_icon"
                      >
                        <option value="" selected="">Select icon</option>
                        <option v-for="icon in icon4" :key="icon" :value="icon">
                          {{ icon }}
                        </option>
                      </select>
                    </fieldset>
                  ...
                  <div class="col-12">
                    <fieldset class="form-group">
                      <label for="basicSelect2"
                        >Icon (font awesome 5) optional</label
                      >
                      <select
                        class="form-select"
                        id="basicSelect2"
                        v-model="form.fa5_icon"
                        name="fa5_icon"
                      >
                        <option value="" selected="">Select icon</option>
                        <option v-for="icon in icon5" :key="icon" :value="icon">
                          {{ icon }}
                        </option>
                      </select>
                    </fieldset>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      let id = vm.$nuxt.$route.params.id
      this.$axios
        .post('admin/settings/' + id + '?_method=PUT', this.form)
        .then((res) => {
          vm.loading = false
          console.log(res)
