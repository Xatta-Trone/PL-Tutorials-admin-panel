  ...
  <div>
    ...
    <div v-else>
      <pageheader
        ...
        urltxt="Add permissions"
      ></pageheader>

      <div class="col-12"></div>
      <v-server-table
        :url="serverurl + 'admin/permissions?type=' + selectData"
        :columns="columns"
        :options="options"
      >
...
export default {
  ...
  methods: {
    edit(data) {
      console.log(data)
      this.$nuxt.$router.push('/permissions/edit/' + data.id)
    },
