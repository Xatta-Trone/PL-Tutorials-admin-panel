<template>
  <div>
        ...
        <div class="card">
          <div class="card-body px-3 py-4-5">
            <div class="row">
              ...
              <div class="col-md-8">
                <h6 class="text-muted font-semibold">New Contact</h6>
                <h6 class="font-extrabold mb-0">{{ dashboard.new_contact }}</h6>
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <h4>Activities in last 30 days</h4>
      <apexchart
        ref="realtimeChart"
        width="100%"
        height="300"
