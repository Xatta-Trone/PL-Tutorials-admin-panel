  ...
  <div>
    ...
    <div v-else>
      <pageheader
        ...
        urltxt="Add Ban locations"
      ></pageheader>

      <div class="col-12"></div>
      <v-server-table
        :url="serverurl + 'admin/bans?type=' + selectData"
        :columns="columns"
        :options="options"
      >
        <div
...
export default {
  ...
  methods: {
    edit(data) {
      console.log(data)
      this.$nuxt.$router.push('/bans/edit/' + data.id)
    },
    ...
    handleDelete(data, i) {
      ...
      if (confirm(msg)) {
        ...
        this.$axios
          .delete(
            '/admin/bans/' + data.id + '?forcedelete=' + forcedelete.toString()
          )
          .then((res) => {
            vm.loading = false
